...
#define STRING_CONFIG_H_AUTHOR "(Cameron, Vector 3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Vector 3"
 ...
 *    72 : 100k thermistor found in Vector 3 with (1k pullup)
 *    73 : 100k thermistor found in vector 3 bed with (1k pullup)
